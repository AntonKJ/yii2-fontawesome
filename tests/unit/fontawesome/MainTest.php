...
namespace antonkj\yii\fontawesome\tests\unit\fontawesome;

use antonkj\yii\fontawesome\component\Icon;
use antonkj\yii\fontawesome\FA;
use antonkj\yii\fontawesome\FontAwesome;

/**
 * Class MainTest
 * @package antonkj\yii\fontawesome\tests\unit\fontawesome
 */
class MainTest extends \antonkj\yii\fontawesome\tests\unit\TestCase
{

    public function testMain()
    {
        $this->assertInstanceOf('antonkj\yii\fontawesome\FA', new FA());
        $this->assertInstanceOf('antonkj\yii\fontawesome\FontAwesome', new FA());

        $this->assertInstanceOf('antonkj\yii\fontawesome\FontAwesome', new FontAwesome());

        $Icon = FA::icon('cog');
        $this->assertInstanceOf('antonkj\yii\fontawesome\component\Icon', $Icon);

        $Stack = FA::stack();
        $this->assertInstanceOf('antonkj\yii\fontawesome\component\Stack', $Stack);
    }
