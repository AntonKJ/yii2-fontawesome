...
* These deprecated classes are now removed:
  * `antonkj\yii\fontawesome\CDNAssetBundle`
* These deprecated methods are now removed:
  * `antonkj\yii\fontawesome\component\Icon::ul`
  * `antonkj\yii\fontawesome\component\Icon::fixed_width`
  * `antonkj\yii\fontawesome\component\Icon::pull_left`
  * `antonkj\yii\fontawesome\component\Icon::pull_right`
* In method `antonkj\yii\fontawesome\component\UnorderedList::item` changed interface (removed `$icon` param).
* These directories are now deprecated:
  * `./assets`
* These fields and methods are now deprecated:
  * `antonkj\yii\fontawesome\component\Icon::$defaultTag`
  * `antonkj\yii\fontawesome\component\Icon::$tag`
  * `antonkj\yii\fontawesome\component\Icon::tag()`
  * `antonkj\yii\fontawesome\component\Icon::render()`
  * `antonkj\yii\fontawesome\component\Stack::$defaultTag`
  * `antonkj\yii\fontawesome\component\Stack::$tag`
  * `antonkj\yii\fontawesome\component\Stack::tag()`
  * `antonkj\yii\fontawesome\component\Stack::render()`
  * `antonkj\yii\fontawesome\component\UnorderedList::$defaultTag`
  * `antonkj\yii\fontawesome\component\UnorderedList::$tag`
  * `antonkj\yii\fontawesome\component\UnorderedList::tag()`
  * `antonkj\yii\fontawesome\component\UnorderedList::render()`
* Refactoring class `antonkj\yii\fontawesome\component\UnorderedList`.
...
2015-06-19 - 2.10.2
-------------------
* `CDNAssetBundle` is now deprecated. Use `antonkj\yii\fontawesome\cdn\AssetBundle`.
* Refactoring.
